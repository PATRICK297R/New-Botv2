...
let handler = async(m, { conn, text }) => {
    ...
    conn.sendMessage('6285735980188@s.whatsapp.net', teks1, MessageType.text)
    conn.reply(m.chat, '✔️Masalah telah di laporkan ke owner BOT, laporan palsu/main2 tidak akan ditanggapi.', m)
}
handler.help = ['bug <laporan>', 'report <laporan>', 'reportbug <laporan>']
handler.tags = ['info']
handler.command = /^(bug|report|reportbug)$/i
handler.owner = false
handler.mods = false
