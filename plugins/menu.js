...
let moment = require('moment-timezone')
    ...
    const ultah = new Date('September 2, 2022 23:59:59')
...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  let arrayMenu = ['all', 'game', 'edukasi', 'news', 'nsfw', 'xp', 'stiker', 'image', 'cristian', 'anime', 'kerangajaib', 'quotes', 'admin', 'rpg', 'grup', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database', 'quran', 'audio', 'jadibot', 'info', 'vote', 'owner']
  ...
  try {
                        ...
                        "sections": [
                            {
                                ...
                                "rows": [{
                                    ...
                                    "title": "|🥷| Anonymous",
                                    "description": "Mainkan Anonymous Chat (Private Server)",
                                    "rowId": ".? anonymous"
                                }, { 
                                    "title": "|✒️| Nulis & Logo",
                                    ...
                                    "title": "|🤖| Jadi Bot",
                                    "description": "Jadi Bot (khusus premium)",
                                    "rowId": ".? jadibot"
                                }, { 
                                    "title": "|⛩️| Anime",
    ...
    await conn.send2ButtonImg(m.chat, await (await fetch(thumbfoto)).buffer(), text.trim(), `${totalreg} User🤠🥀`, 'Pemilik Bot', `${_p}owner`, 'BuyPrem', `${_p}belipremium`)
  } catch (e) {
