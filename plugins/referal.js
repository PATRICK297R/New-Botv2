...
const xp_first_time = 1000000
const xp_link_creator = 1000000
const xp_bonus = {
    5: 2000000,
   10: 5000000,
   20: 8000000,
...
let handler = async (m, { conn, usedPrefix, text }) => {
  ...
  if (text) {
    if ('ref_count' in users[m.sender]) throw 'Tidak bisa menggunakan kode referal! / Kamu sudah menggunakan kode referal orang lain!'
